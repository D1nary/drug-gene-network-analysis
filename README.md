...
- `results/`: Generated analysis outputs.
  ...
  - `results/embedding/`: Embedding CSV outputs generated by the selected algorithm.
 ...
 - `parameters/`: Hyperparameter configuration files for embedding algorithms.
  - `parameters/node2vec/hyperparameters.json`: Node2Vec hyperparameters.
  - `parameters/metapath2vec/hyperparameters.json`: MetaPath2Vec hyperparameters.
...
before running the embedding stage. All Node2Vec hyperparameters are loaded
exclusively from `parameters/node2vec/hyperparameters.json`.
